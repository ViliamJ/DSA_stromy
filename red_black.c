//
// Created by Viliam on 23.03.2021.
//
...
void rightRotate_red_black(struct node **root,struct node *y)
{
    if (!y || !y->left)
        return ;
    ...
    while (z != *root && z != (*root)->left && z != (*root)->right && z->parent->color == 'R')
    {
        ...
        else
        {
                ...
                z == z->parent->left)
            {
                ...
                rightRotate_red_black(root,z->parent->parent);
            }
                ...
                z == z->parent->left)
            {
                ...
                z->color = z->parent->parent->color;
                z->parent->parent->color = ch;
                rightRotate_red_black(root,z->parent);
                LeftRotate(root,z->parent->parent);
            }
        }
    }
...
void insert_redblack(struct node **root, int data)
{
